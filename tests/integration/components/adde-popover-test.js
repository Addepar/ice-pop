...
module('Integration | Component | adde-popover', function(hooks) {
...
module('Unit | Component | adde-popover', function(hooks) {
  setupTest(hooks);

  test('popper modifiers are customizable', function(assert) {
    assert.expect(2);

    let popover = this.owner.factoryFor('component:adde-popover').create({});
    assert.deepEqual(
